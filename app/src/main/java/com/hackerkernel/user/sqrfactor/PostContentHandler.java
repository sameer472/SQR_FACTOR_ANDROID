        ...
        for(Element element :elements){
            ...
            if(tag.getName().equalsIgnoreCase("a")){
                ...
                for(String s : parsedBody) {
                    if(s.equals("b")||s.equals("/b")||s.equals("/span")||s.equals(":")||s.equals("i")||s.equals("br")||s.equals(".")||s.equals("/i")||s.contains("style=")||s.contains("&nbsp")||s.contains("<span")||s.contains("</span>")||s.contains("<br>"))
                    {
                        continue;
                    }
                    else{
